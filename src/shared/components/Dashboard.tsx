    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm text-gray-600">Yêu cầu chờ</p>
      ...
      <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <button className="p-4 border-2 border-gray-200 rounded-lg hover:border-blue-500 hover:bg-blue-50 transition duration-200 text-left">
            <div className="font-medium text-gray-900 mb-1">Tạo yêu cầu nghỉ phép</div>
            <div className="text-sm text-gray-600">Gửi yêu cầu nghỉ phép cho quản lý</div>
          </button>
          
          <button className="p-4 border-2 border-gray-200 rounded-lg hover:border-blue-500 hover:bg-blue-50 transition duration-200 text-left">
            <div className="font-medium text-gray-900 mb-1">Đăng ký hoạt động</div>
            <div className="text-sm text-gray-600">Tham gia các hoạt động của công ty</div>
          </button>
          
          <button className="p-4 border-2 border-gray-200 rounded-lg hover:border-blue-500 hover:bg-blue-50 transition duration-200 text-left">
            <div className="font-medium text-gray-900 mb-1">Đổi điểm thưởng</div>
