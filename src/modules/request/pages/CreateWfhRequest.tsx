    ...
    >
      ...
      <div className="mt-6 grid grid-cols-1 gap-y-4 sm:grid-cols-2 sm:gap-x-6">
        ...
        <div className="sm:col-span-2 flex items-center gap-2">
          ...
          <span className="text-sm">Tôi cam kết đảm bảo tiến độ công việc</span>
        </div>
      </div>

      <div className="mt-6 flex flex-col-reverse gap-3 sm:flex-row sm:justify-between">
        <button className="rounded-lg border px-4 py-2 text-sm hover:bg-gray-50">Hủy</button>
        <button className="rounded-lg bg-black px-6 py-2 text-sm text-white hover:bg-gray-800">Gửi</button>
      </div>
    </div>
  );
