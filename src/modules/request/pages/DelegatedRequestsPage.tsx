...
const DelegatedRequestsPage: React.FC = () => {
                ...
                <div className="bg-white border-b border-gray-200 rounded-t-xl px-6 py-4 flex items-center justify-between">
                    <div className="flex items-center gap-4">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                            ...
                            />
                            <path
                                d="M4 20v-1c0-2.5 4-3.5 8-3.5s8 1 8 3.5V20"
                                stroke="currentColor"
                                strokeWidth="2"
                                strokeLinecap="round"
                                strokeLinejoin="round"
                        ...
                        <h2 className="text-lg font-bold text-gray-900">Yêu cầu được ủy quyền</h2>
                    </div>
                    <div
...
export default DelegatedRequestsPage;
