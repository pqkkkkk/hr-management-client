      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-base text-slate-500">
            ...
            <span className="font-semibold text-blue-600">{remainingDays} ngày</span>
          </p>
        </div>
          ...
          <div className="space-y-6">
            ...
            <div className="flex justify-end gap-4 pt-4">
              ...
              <button
                ...
                disabled={isSubmitting}
                className="h-12 px-6 bg-blue-600 text-white font-bold text-base rounded-lg hover:bg-blue-700 disabled:opacity-80 flex items-center gap-2"
              >
                {isSubmitting ? (
                  <>
